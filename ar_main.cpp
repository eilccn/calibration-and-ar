        ...
        *capdev >> frame; 
        ...
        // AXES
            ...
            if (found) {
                ...
                // highlight corners 
                cv::circle(convertedImage, corners[0], 30, {255, 0, 30}, FILLED, 3);
                cv::circle(convertedImage, corners[8], 30, {255, 0, 30}, FILLED, 3);
                cv::circle(convertedImage, corners[45], 30, {255, 0, 30}, FILLED, 3);
                cv::circle(convertedImage, corners[53], 30, {255, 0, 30}, FILLED, 3);
        ...
        // 3D OBJECT
            ...
            if (found) {
                ...
                cout << "image points" << endl;
                for (auto &n : cubeProjectedPoints) {
                    cout << n << endl;
                }

                // draw lines from origin corner to projected image points
                //cv::line(convertedImage, corners[0], axesProjectedPoints[0], {255,0,0}, 5);
                //cv::line(convertedImage, axesProjectedPoints[1], axesProjectedPoints[2], {0,255,0}, 5);
                //cv::line(convertedImage, axesProjectedPoints[2], axesProjectedPoints[3], {0,0,255}, 5);
                //cv::line(convertedImage, axesProjectedPoints[3], axesProjectedPoints[0], {255,0,0}, 5);
                //cv::line(convertedImage, axesProjectedPoints[0], axesProjectedPoints[4], {0,255,0}, 5);
                //cv::line(convertedImage, axesProjectedPoints[1], axesProjectedPoints[5], {0,0,255}, 5);
                //cv::line(convertedImage, axesProjectedPoints[2], axesProjectedPoints[6], {255,0,0}, 5);
                //cv::line(convertedImage, axesProjectedPoints[3], axesProjectedPoints[7], {0,255,0}, 5);
                //cv::line(convertedImage, axesProjectedPoints[4], axesProjectedPoints[5], {0,0,255}, 5);
                //cv::line(convertedImage, axesProjectedPoints[5], axesProjectedPoints[6], {0,0,255}, 5);
                //cv::line(convertedImage, axesProjectedPoints[6], axesProjectedPoints[7], {0,0,255}, 5);
                //cv::line(convertedImage, axesProjectedPoints[7], axesProjectedPoints[4], {0,0,255}, 5);
